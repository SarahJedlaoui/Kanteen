                      ...
                      <div className="w-1/2">
                        <div className="mb-5 relative  items-center  rounded-lg justify-center h-[400px]">
                          <video autoPlay muted loop controls className="absolute  rounded-lg inset-0 w-full h-full object-cover">
                            <source src="https://d205gdf6tf9tly.cloudfront.net/tokyo/idea1.mov" type="video/mp4" />
                  ...
                  <div className="fullwidth sm:w-1/2 px-0 py-1 flex flex-col max-w-4xl mx-auto rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="flex overflow-hidden rounded-md items-center justify-center ">
                      <div className="w-1/2">
                        <div className="mb-5 relative  items-center  rounded-lg justify-center h-[400px]">
                          <video autoPlay muted loop controls className="absolute  rounded-lg inset-0 w-full h-full object-cover">
                            <source src="https://d205gdf6tf9tly.cloudfront.net/tokyo/idea4.mov" type="video/mp4" />
                            Your browser does not support the video tag.
                          </video>
                        </div>
                      </div>
                  ...
                  <div className="fullwidth sm:w-1/2 px-0 py-1 flex flex-col max-w-4xl mx-auto rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="flex overflow-hidden rounded-md items-center justify-center ">
                      <div className="w-1/2">
                        <div className="mb-5 relative  items-center  rounded-lg justify-center h-[400px]">
                          <video autoPlay muted loop controls className="absolute  rounded-lg inset-0 w-full h-full object-cover">
                            <source src="https://d205gdf6tf9tly.cloudfront.net/tokyo/idea6.mov" type="video/mp4" />
                            Your browser does not support the video tag.
                          </video>
                        </div>
                      </div>
                  ...
                  <div className="fullwidth sm:w-1/2 px-0 py-1 flex flex-col max-w-4xl mx-auto rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="flex overflow-hidden rounded-md items-center justify-center ">
                      <div className="w-1/2">
                        <div className="mb-5 relative  items-center  rounded-lg justify-center h-[400px]">
                          <video autoPlay muted loop controls className="absolute  rounded-lg inset-0 w-full h-full object-cover">
                            <source src="https://d205gdf6tf9tly.cloudfront.net/tokyo/idea7.mov" type="video/mp4" />
                            Your browser does not support the video tag.
                          </video>
                        </div>
                      </div>
                      <div className="w-1/2 ml-2 mb-5 h-[400px] p-4 bg-white  rounded-lg shadow-lg overflow-hidden">
                        <div className="text-lg font-bold mb-2">Hook </div>
                        <div className="text-gray-700 text-sm mb-2">
                          <p>&ldquo;Level up your chicken game! &ldquo;</p>
                        </div>
                        <div className="text-lg font-bold mb-2">Core</div>
                        <div className="text-gray-700 text-sm mb-2">
                    ...
                    <div className="px-2 pt-4 pb-2">
                      ...
                      <div className="flex flex-col space-y-3">
                        <div className="p-4 bg-white  rounded-lg shadow-lg overflow-hidden">
                          <div className="text-gray-700 text-sm">
                            <p><strong>Caption: </strong>&ldquo;Level up your chicken game, your favorite chip flavor is now on crispy, juicy chicken.&ldquo;</p>
                            <p><strong>Hashtags: </strong>#SpicyChicken #FriedChicken #DoritosFriedChicken #MustTry</p>
                          </div>
                        </div>
