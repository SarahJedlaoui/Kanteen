    ...
    <>
      ...
      >
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-0 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-6 max-w-[390px] lg:mb-5">
                ...
                Elevate your restaurant&apos;s social media with our AI-powered video creator. We expertly transform photos and videos from your camera roll into engaging stories that capture the essence of your restaurant and the unique culinary experiences it offers. 
        ...
        <div className="absolute right-0 top-14 z-[-1]">
          ...
          >
            <circle opacity="0.8" cx="49.5" cy="49.5" r="49.5" fill="#e7edec" />
            <mask
              id="mask0_94:899"
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#c9f269" stopOpacity="0.62" />
              ...
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#c9f269" stopOpacity="0" />
                <stop offset="1" stopColor="#c9f269" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
