...
const BlogDetailsPage = () => {
  ...
  const [rate2, setRate2] = React.useState<number | undefined>(4);
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post('/api/restaurants/media', formData, {
        headers: {
  ...
  useEffect(() => {
    ...
    const fetchFeedbackEntries = async () => {
      try {
        setLoadingg(true);
        const response = await axios.get('/api/restaurants/media');
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                <p className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                  <strong className="text-green underline dark:text-white">
                    Description:
                  </strong> L&apos;Mida is a Moroccan-Mediterranean restaurant located at 2359 Chestnut Street in the Marina/Cow Hollow neighborhood of San Francisco. The name &ldquo;L&apos;Mida&ldquo; means &ldquo;the table&ldquo; in North African Arabic, symbolizing a place where family and friends gather to share food and stories.
                  The restaurant is known for its elegant ambiance, featuring handmade mosaics and detailed murals that enhance the dining experience. L&apos;Mida offers a diverse menu that combines the flavors of Morocco and the Mediterranean, focusing on health, flavor, and the use of fresh ingredients with aromatic spices.
                </p>
                ...
                <div>
                  ...
                  <p className="-mt-8 mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                  ...
                                  {entry.files.map((file, fileIndex) => (
                                    file.contentType.startsWith('image/') ? (
                                      <Box
                                        ...
                                        src={`data:${file.contentType};base64,${file.buffer}`}
                                        alt={file.filename}
                                      />
                                    ) : (
                                      <video
